...
export const metadata: Metadata = {
  ...
  description: "Coming soon — ICT Registration Guide for Tour Operators in Costa Rica. A guide for Caribbean coast hospitality operators by HLPFL.",
  alternates: { canonical: "https://hlpfl.org/blog/ict-registration-guide-tour-operators-costa-rica/" },
};
      ...
      <section className="section">
        <div className="max-w-[800px] mx-auto px-4">
          ...
          <h1 className="font-display text-4xl md:text-6xl tracking-wide leading-none mb-6">
            ICT Registration Guide for Tour Operators in Costa Rica
          </h1>
