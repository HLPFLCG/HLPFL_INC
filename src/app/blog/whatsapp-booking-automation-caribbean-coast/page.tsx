...
export const metadata: Metadata = {
  ...
  description: "Coming soon — WhatsApp Booking Automation for Caribbean Coast Businesses. A guide for Caribbean coast hospitality operators by HLPFL.",
  alternates: { canonical: "https://hlpfl.org/blog/whatsapp-booking-automation-caribbean-coast/" },
};
      ...
      <section className="section">
        <div className="max-w-[800px] mx-auto px-4">
          ...
          <h1 className="font-display text-4xl md:text-6xl tracking-wide leading-none mb-6">
            WhatsApp Booking Automation for Caribbean Coast Businesses
          </h1>
