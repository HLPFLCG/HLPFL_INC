    ...
    <div className="pt-24 min-h-screen bg-cream">
      <section className="section">
        <div className="max-w-[800px] mx-auto px-4">
          ...
          <h1 className="font-display text-5xl md:text-7xl tracking-wide leading-none mb-4 text-night">Terms of Service</h1>
          <p className="text-bark text-sm mb-12">Last updated: April 2026</p>

          <div className="prose max-w-none text-fog space-y-8">
            <div>
              <h2 className="font-display text-2xl text-night tracking-wide mb-3">Services</h2>
            ...
            <div>
              <h2 className="font-display text-2xl text-night tracking-wide mb-3">Engagement</h2>
            ...
            <div>
              <h2 className="font-display text-2xl text-night tracking-wide mb-3">Intellectual Property</h2>
            ...
            <div>
              <h2 className="font-display text-2xl text-night tracking-wide mb-3">Limitation of Liability</h2>
            ...
            <div>
              ...
              <p>Questions about these terms: <a href="mailto:hello@hlpfl.org" className="text-sea hover:text-canopy">hello@hlpfl.org</a></p>
            </div>
          </div>
        </div>
      </section>
