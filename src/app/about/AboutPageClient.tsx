      ...
      <section className="section bg-void-light">
        <div className="max-w-[800px] mx-auto px-4">
          <ScrollReveal>
            ...
            <p className="text-gray-300 text-base md:text-lg leading-relaxed">{about.missionDesc}</p>
          </ScrollReveal>
        </div>
      </section>
        ...
        <div className="max-w-[900px] mx-auto px-4">
          ...
          {about.values.map((v, i) => (
            <ScrollReveal key={i} delay={i * 0.1}>
              <div className={`flex gap-6 items-start py-7 ${i < about.values.length - 1 ? "border-b border-void-lighter" : ""}`}>
