...
export default function ResultsSection() {
  ...
  return (
    <section className="section bg-jungle" id="results">
      <div className="container-custom">
        <ScrollReveal>
          <span className="text-gold uppercase tracking-[0.25em] text-xs mb-4 block text-center">
            {home.resultsOverline}
          </span>
          <h2 className="font-display text-4xl md:text-5xl lg:text-6xl text-center mb-16 tracking-wide leading-none text-sand">
            {home.resultsTitle}{" "}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {home.resultsMetrics.map((metric, i) => (
            <ScrollReveal key={i} delay={i * 0.08}>
              <div className="bg-jungle border border-sea/20 p-8 text-center group transition-all duration-300 hover:border-sea">
